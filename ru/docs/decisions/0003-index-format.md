...
> Судьбу неназванной метрики в деталях переопределило [0029](0029-metric-grid-rows.md):
> она не показывается, как и на превью. Всё остальное — формат, `style` как есть, раскладки
> под ширину — действует как написано.
