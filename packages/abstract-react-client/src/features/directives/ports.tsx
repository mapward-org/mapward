...
export type DirectivesPort = {
  ...
  /**
   * Кнопка этапа: фраза уходит в живую сессию объекта (решение 0017). Объект называется в
   * вызове: у карточки на чужом экране он свой, а не открытый.
   */
  runStage?: ((object: MapObject, file: MapFile, stage: string) => void) | undefined;
};
